...
\newcommand{\strAuthorC}{O. Manz}
\newcommand{\strAuthorAEmail}{thgnaedi@htwg-konstanz.de}
\newcommand{\strAuthorBEmail}{fagendus@htwg-konstanz.de}
\newcommand{\strAuthorCEmail}{olmanz@htwg-konstanz.de}
% Versuchsbeschreibung 
\newcommand{\strTopic}{Digitalisierung}
\newcommand{\strAbstract}{Dieser Versuch befasst sich mit einigen Phänomenen der Digital-Analog und Analog-Digital Wandlung.}
...
\chapter{Einleitung}
\label{chap:EINL}
Dieser Laborbericht befässt sich mit der Umwandlung analoger Signale in Ditigale und umgekehrt. Dabei kommt die AD/DA - Wandlerkarte ME-RedLab USB-1208LS zum Einsatz.
Lernziele hierbei sind
\begin{itemize}
...
\item{Praktische Erfahrungen mit dem Abtasttheorem}
\end{itemize}
...
% CHAPTER Versuch 3
%
\input{Versuche/v3.tex}

%
% CHAPTER Versuch 4
%
\input{Versuche/v4.tex}

%
% CHAPTER Versuch 5
%
\input{Versuche/v5.tex}
...
\begin{figure}[H]
    \centering
	\includegraphics[width=170mm,scale=0.5]{media/protokoll.pdf}
	\caption{Protokoll}
	\label{img:protokoll}
\end{figure}
