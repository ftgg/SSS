 ...
 \begin{lstlisting}[style=PYTHON,frame=single,
  ...
  def ein_ausgang():
      ...
      resize_mic = input_mic[:,1:2] * 40  # mal 40, da mikrophonsignal etwa 40 mal schwächer ist
  ...
  def amplitude(datak, datag, x):
      ...
      plt.semilogx(x, datag, label="großer Lautsprecher")
      plt.xlabel("Frequenz")
