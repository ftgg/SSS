...
\newcommand{\strAbstract}{In diesem Versuch wird ein einfacher Spracherkenner aufgebaut.
Insgesamt soll er vier Befehle voneinander unterscheiden können.}
...
\chapter{Einleitung}
\label{chap:EINL}
In diesem Versuch soll ein einfacher Spracherkenner aufgebaut werden.
Insgesamt soll er einen Wortschatz haben, der sich über vier Wörter erstreckt.
Diese sind:
\begin{itemize}
\item{Hoch}
\item{Tief}
...
\item{Rechts}
\end{itemize}
So könnte der Spracherkenner beispielsweise für die Steuerung eines Staplers eingesetzt werden.
Das Prinzip der Spracherkennung folgt nach dem Prinzp des Prototyp-Klassifikators.
Weiter wird die Windowing-Medthode eingesetzt. Die Spracherkennung erfolgt in der Fourierdomäne.
Das heißt es sollen die Spektren verglichen werden.
Die Aufgabe teilt sich in zwei Versuche auf, so dass das Ziel Spracherkennung in zwei Schritte aufgeteilt wird.
\begin{itemize}
\item{Fourieranalyse lang andauernder Signale}
\item{Spracherkennung}
\end{itemize}
In der ersten Teilaufgabe werden die Vorbereitungen auf den zweiten Versuch - die eigentliche Spracherkennung durchgeführt.
Im Zweiten werden dann die im ersten teil gewonnenen Ergebnisse für die Spracherkennung angewandt.
Der Spracherkenner wird in der Programmiersprache Python implementiert.


%
% CHAPTER Versuch 1
%
\input{Versuche/v1.tex}

%
% CHAPTER Versuch 2
%
\input{Versuche/v2.tex}
